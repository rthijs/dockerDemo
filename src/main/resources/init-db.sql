...
INSERT INTO public.quote (id,author,quote) VALUES (
nextval('seq_quote'),'Albert Einstein','The difference between stupidity and genius is that genius has its limits.');
INSERT INTO public.quote (id,author,quote) VALUES (
nextval('seq_quote'),'Oscar Wilde','Be yourself; everyone else is already taken.');
INSERT INTO public.quote (id,author,quote) VALUES (
nextval('seq_quote'),'J.R.R. Tolkien','All that is gold does not glitter,\nNot all those who wander are lost;\nThe old that is strong does not wither,\nDeep roots are not reached by the frost.\n\nFrom the ashes a fire shall be woken,\nA light from the shadows shall spring;\nRenewed shall be blade that was broken,\nThe crownless again shall be king.');
INSERT INTO public.quote (id,author,quote) VALUES (
nextval('seq_quote'),'David Allen','You can do anything, but not everything.');
INSERT INTO public.quote (id,author,quote) VALUES (
